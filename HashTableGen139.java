    ...
    extends HashTableTemplate
{
    ...
    protected HashTableTemplate.BatchHolder newBatchHolder(int arg1, int arg2) {
        return new HashTableGen139 .BatchHolder(arg1, arg2);
    }
    ...
    {
        {
            ...
            if (tmp2 == null) {
                throw new SchemaChangeException("Failure while loading vector vv0 with id: TypedFieldId [fieldIds=[2], remainder=null].");
            }
            vv0 = ((IntVector) tmp2);
            ...
            if (tmp8 == null) {
                throw new SchemaChangeException("Failure while loading vector vv6 with id: TypedFieldId [fieldIds=[0], remainder=null].");
            }
            vv6 = ((IntVector) tmp8);
            /** start SETUP for function hash32AsDouble **/ 
            {
        ...
        {
            {
                ...
                if (tmp20 == null) {
                    throw new SchemaChangeException("Failure while loading vector vv18 with id: TypedFieldId [fieldIds=[2], remainder=null].");
                }
